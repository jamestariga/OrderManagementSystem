...
<div class="col-lg-12">
	...
	<div class="row">
	    ...
	    <?php if($_SESSION['login_type'] !=3): ?> <!-- I added an IF statement to ensure that the additional advanced search functions are only available to admins and employees -->
				<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-body">
			<div class="d-flex w-100 px-1 py-2 justify-content-center align-items-center">
				...
				<div class="input-group col-sm-5">
          <input type="date" id="date_created" class="form-control form-control-sm" placeholder="Type the date order was placed here">
          <div class="input-group-append">
            <button type="button" id="track-btn" class="btn btn-sm btn-primary btn-gradient-primary">
                <i class="fa fa-search"></i>
            </button>
	...
	<div class="card card-outline card-primary">
		<div class="card-body">
			<div class="d-flex w-100 px-1 py-2 justify-content-center align-items-center">
				<label for="">Enter Order Status</label>
				<div class="input-group col-sm-5">
          <input type="search" id="status" class="form-control form-control-sm" placeholder="Type the status of the order here">
          <div class="input-group-append">
            <button type="button" id="track-btn" class="btn btn-sm btn-primary btn-gradient-primary">
              <i class="fa fa-search"></i>
            </button>
	...
	<div class="card card-outline card-primary">
		<div class="card-body">
			<div class="d-flex w-100 px-1 py-2 justify-content-center align-items-center">
				...
				<div class="input-group col-sm-5">
          <input type="search" id="price" class="form-control form-control-sm" placeholder="Type the total price of the order here">
          <div class="input-group-append">
            <button type="button" id="track-btn" class="btn btn-sm btn-primary btn-gradient-primary">
              <i class="fa fa-search"></i>
            </button>
